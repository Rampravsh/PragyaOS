    ...
    <div className="bg-background text-foreground transition-colors duration-normal ease-in-out min-h-screen pb-16">
      ...
      <section className="relative overflow-hidden py-20 md:py-28 border-b border-stone-200 dark:border-stone-850 bg-white/40 dark:bg-stone-900/10">
        ...
        <div className="absolute right-8 top-1/4 opacity-10 dark:opacity-20 hidden lg:block">
          <AuthTwig color="#BE185D" strokeWidth={1} className="w-24 h-72" />
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center flex flex-col items-center gap-6 relative">
          ...
          >
            <AuthSparkle color="#BE185D" className="w-5 h-5 animate-pulse" />
            <span className="text-[10px] font-sans font-bold tracking-[0.2em] uppercase text-[#BE185D]">
          ...
          >
            Learn together.
            <br />
            Build with a <span className="text-[#BE185D]">thriving peer network.</span>
          </motion.h1>
          ...
          >
            Participate in discussion rooms, solve coding errors together, host study events, and
            climb leaderboard challenges natively within the platform.
          </motion.p>
          ...
          >
            <Link
              to="/register"
              className="inline-flex items-center justify-center h-12 px-6 rounded-xl bg-stone-900 hover:bg-black dark:bg-[#BE185D] dark:hover:bg-[#9D174D] text-white dark:text-white text-sm font-sans font-bold transition-all duration-200 hover:shadow-md"
            >
              Join the Network
            </Link>
          </motion.div>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-24 flex flex-col gap-16">
        {[
          {
            title: "1. Discussion Channels",
            subtitle: "Solve errors side-by-side",
            desc: "Attach code snippets directly to comments. Highlight specific units and ask questions without jumping off the video player window.",
            image: "Forum thread cards showing discussions on React hooks",
            side: "left",
          },
          {
            title: "2. Peer Study Groups",
            subtitle: "Team up for course paths",
            desc: "Create public or private study groups. Challenge teammates, schedule collaborative coding sprints, and review progress logs together.",
            image: "Active groups page showing member grids and study paths",
            side: "right",
          },
          {
            title: "3. Friendly Leaderboard Tracks",
            subtitle: "Gamified learning stats",
            desc: "Gain points for completing units, answering peers, and submitting assignments. View daily and weekly rankings across cohorts.",
            image: "Gamified leaderboard displaying top student profiles",
            side: "left",
          },
          {
            title: "4. Collaborative Peer Reviews",
            subtitle: "Receive direct code reviews",
            desc: "Review pull requests submitted by other students. Solve blockers, exchange feedback comments, and earn collaborative credits.",
            image: "Peer review dashboard showing user code annotations",
            side: "right",
          },
        ].map((feature, i) => (
          <div
          ...
          >
            <div className={`flex flex-col gap-4 ${feature.side === "right" ? "lg:order-2" : ""}`}>
              <span className="font-mono text-xs text-[#BE185D] font-bold uppercase tracking-wider">
                {feature.subtitle}
              </span>
      ...
      <section className="max-w-5xl mx-auto px-4 py-8">
        <div className="bg-stone-900 dark:bg-stone-900/60 rounded-3xl p-8 sm:p-12 text-center flex flex-col items-center gap-6 border border-stone-800 relative overflow-hidden">
          ...
          <h2 className="font-serif font-bold text-3xl sm:text-4xl text-white tracking-tight leading-tight">
            Join the Pragya Community
          </h2>
          <p className="font-sans text-xs sm:text-sm text-stone-400 max-w-xl leading-relaxed">
            Collaborate, review, and learn side-by-side with developers from around the globe.
          </p>
