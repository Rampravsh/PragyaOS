...
const CARDS: HubCard[] = [
  {
    ...
    link: "/resources/blog",
    icon: <BookIcon size={22} className="text-[#c79436]" />,
    items: [
      "Editorial Blog",
  ...
  },
  {
    ...
    icon: <PencilIcon size={22} className="text-[#c79436]" />,
  ...
  },
  {
    ...
    icon: <LayersIcon size={22} className="text-[#c79436]" />,
    items: [
      "Payments guides",
  ...
  },
  {
    ...
    icon: <UsersIcon size={22} className="text-[#c79436]" />,
    items: [
      "General Discussions",
      "Showcase creations",
      "Live events feed",
...
export function ResourcesHubComposition(): React.JSX.Element {
  return (
    <div className="bg-[#FAF7F2] dark:bg-[#0f0f10] min-h-screen py-16 lg:py-24">
            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  {/* Category Pill Tag */}
                  <span className="px-3 py-1 bg-[#FAF7F2] dark:bg-stone-900 border border-stone-250 dark:border-stone-800 rounded-lg text-[10px] font-sans font-bold text-stone-700 dark:text-stone-300 uppercase tracking-wider">
                    {card.category}
                  </span>
                  {/* Icon */}
                  <div className="w-10 h-10 rounded-xl bg-[#FAF7F2] dark:bg-stone-900 border border-stone-200 dark:border-stone-800/80 flex items-center justify-center">
                    {card.icon}
                  </div>
                </div>
              ...
              <div>
                <AnimatedNavLink
                  ...
                  className="w-full inline-flex items-center justify-center py-3 bg-[#1C1917] hover:bg-black text-white dark:bg-white dark:text-stone-950 font-sans font-bold text-xs uppercase tracking-wider rounded-xl text-center shadow-sm border-2 border-stone-850 dark:border-stone-800"
                >
                  Explore &rarr;
                </AnimatedNavLink>
              </div>
