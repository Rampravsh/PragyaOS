...
import { CalendarIcon, UsersIcon } from "@pragyaos/icons";
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="inline-flex items-center gap-1.5 text-[10px] font-sans font-bold text-brand-gold uppercase tracking-widest block mb-3">
            <UsersIcon size={12} className="inline-block" /> Connected Cohorts
          </span>
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            ...
            <div className="bg-white dark:bg-stone-950 p-6 rounded-2xl border-2 border-stone-850 dark:border-stone-800 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,0.06)] text-left">
              <div className="flex items-center gap-3 border-b-2 border-stone-850 dark:border-stone-800 pb-4 mb-6">
                <CalendarIcon size={20} className="text-brand-gold" />
              ...
              <div className="flex flex-col gap-4">
                {EVENTS.map((ev, idx) => (
                  <div
                    key={idx}
                    className="p-3.5 bg-muted border border-stone-200/60 dark:border-stone-800 rounded-xl"
                  >
