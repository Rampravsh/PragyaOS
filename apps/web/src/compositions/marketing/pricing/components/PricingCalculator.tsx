...
export function PricingCalculator({ billingCycle }: PricingCalculatorProps): React.JSX.Element {
  ...
  return (
    <section className="py-16 bg-background/40 border-b border-stone-200/50 dark:border-stone-850">
      <div className="max-w-3xl mx-auto px-4 md:px-6">
        ...
        <div className="bg-white dark:bg-stone-950 p-6 md:p-8 rounded-2xl border-2 border-stone-850 dark:border-stone-800 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,0.06)]">
          <div className="text-center mb-8">
            <span className="text-[10px] font-sans font-bold text-brand-gold uppercase tracking-widest block mb-2">
              Cost Estimator
            </span>
          ...
          <div className="flex flex-col gap-6 mb-8">
            <div className="flex items-center justify-between">
              ...
              <div className="px-4 py-1.5 bg-muted border border-stone-300 dark:border-stone-800 rounded-lg text-sm font-sans font-extrabold text-stone-900 dark:text-white">
                {seats} seats
              </div>
            </div>
            ...
            <input
              ...
              className="w-full accent-brand-gold h-2 bg-stone-100 dark:bg-stone-800 rounded-lg appearance-none cursor-pointer"
            />
          ...
          {/* Results Display */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-muted p-5 rounded-xl border border-stone-200/50 dark:border-stone-800 text-center md:text-left">
            <div>
            ...
            <div className="flex flex-col justify-center items-center md:items-end">
              ...
              <span className="text-xs font-sans font-extrabold text-brand-gold block mb-2">
